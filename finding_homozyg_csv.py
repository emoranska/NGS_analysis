...
import re
import numpy as np
from less_memory_usage import remove_the_same_gt, read_csv
...
drop_dots = just_gt_nan.dropna(thresh=11, subset=['P1-25', 'P1-93', 'P1-88', 'P1-6', 'P1-89', 'P1-26', 'P1-12', 'P1-92', 'P1-22', 'P1-90', 'P1-28', 'P1-95'])


drop_dots_str = drop_dots.to_string()
# print(type(drop_dots), type(drop_dots_str), drop_dots_str)
print(drop_dots_str.head())
