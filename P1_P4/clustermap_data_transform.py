...
df_matrix = pd.read_csv('../files/clustermaps/P1_all_DEGs_cm_general_data.csv', sep='\t')
...
df_final.to_csv('../files/clustermaps/P1_all_DEGs_cm_general_data_final.csv', sep='\t', index=False)
