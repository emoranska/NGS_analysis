...
mites_dens = pd.read_csv('../files/lineplot_density/EL10_mite_density_data.csv', sep='\t')
...
plt.title("EL10_1.0", fontsize=35)
plt.xlabel("Chromosome length [Mb]", fontsize=23)
plt.ylabel("MITE density [per 10 kb]", fontsize=23)
