...
families_de_005 = pd.read_csv('../files/heatmaps/hm_data/P4_families_DE_005.csv', sep='\t').set_index('family')
families_all_genes = pd.read_csv('../files/heatmaps/hm_data/P4_families_all_genes.csv', sep='\t').set_index('family')
fam_all_genes_utr = (pd.read_csv('../files/heatmaps/hm_data/P4_fam_all_genes_st.csv', sep='\t').set_index('family'))
fam_de_005_utr = pd.read_csv('../files/heatmaps/hm_data/P4_fam_DE005_st.csv', sep='\t').set_index('family')
...
fam_updown_utr = (pd.read_csv('../files/heatmaps/hm_data/P4_fam_updown_st.csv', sep='\t').set_index('family'))
...
# vmax = 4.0 for families, 6.0 for superfamilies
    hm1 = sns.heatmap(up_reg, ax=ax1, cmap="YlOrBr", cbar=False, linewidths=.1, xticklabels=labels_x, vmin=0, vmax=4.0)
    hm2 = sns.heatmap(down_reg, ax=ax2, cmap="YlOrBr", cbar=False, linewidths=.1, xticklabels=labels_x, vmin=0, vmax=4.0)
    ...
    # cax = fig.add_axes([0.93, 0.2, 0.01, 0.6])  # for superfamilies
