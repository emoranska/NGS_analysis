...
data_stow_3 = pd.read_csv('../files/heatmaps/cm_data/Stow3_clustermap_data.csv', sep='\t',
                          header=0, index_col=0)

data_stow_36 = pd.read_csv('../files/heatmaps/cm_data/Stow36_clustermap_data.csv', sep='\t', header=0,
                           index_col=0)
...
# changing y-axis label colours according to 'ins_de' values
    ...
    degs_clustermap.savefig(f'../files/heatmaps/clustermaps/{mite_fam}.pdf')
    plt.show()
